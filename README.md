...
------------------------------
This to demonstrate how to add a new script/program/process and execute it inside an already running container via the client web console. **This is not limited to java but any other language such php or nodejs once the container servlet is run as background process.**
