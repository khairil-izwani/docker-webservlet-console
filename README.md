...
5. Run an image that executes container.jar as a foreground (or background) process. *You can refer to Misc and General Knowledge section if you do not know how to do this.*
